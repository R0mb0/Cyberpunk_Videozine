**********************************************************************
*
* Modified to work with Motorola's freeware assembler (AS11.EXE).
* Chris Hand  cph@dmu.ac.uk  28-Mar-93
*
***********************************************************************
*
...
*
* Macro definitions [removed and replaced in-line, cph 28-Mar-93]
*
...
HIRES:      
* CLK=1, Latch=0.   Dummy read 4 dummy bits from glove
        LDAB    #GCLOCK
        STAB    PORTA
...
GETBYTE:    
* CLK=1, Latch=0                Pulse the latch line
        LDAB    #GCLOCK
        STAB    PORTA
