...
extern void set_gmode();              /* enters 320x200x16 mode, clears screen */
extern void restore_gmode();          /* enters 320x200x16 mode w/o  clearing screen */
extern void exit_gmode();             /* exits to text mode */

extern int set_drawpage(int page);	/* set page for drawing on (0-7)   */
...
extern poly3(int x1, int y1, int x2, int y2, int x3, int y3, int color);
				...
				/* color of poly 		    */
extern polyn(int *xp, int *yp, int count, int color);
