     ...
     other timer such as a BBS software's daily event.  Look for
     multiscr.zip at your favorite BBS.
   ...
   * HOW TO START AUTO-RUN:  Place all files in your Telix directory.
     ...
     or at any time wish to stop Auto-Run, simply press the <Esc> key
  ...
  *  Auto-Run's Screen Saver:  Auto-Run should effectively blank your
     ...
     BBS or at the BBS listed below:
         ...
         multiscr.zip - Allows the running of multiple Telix scripts
