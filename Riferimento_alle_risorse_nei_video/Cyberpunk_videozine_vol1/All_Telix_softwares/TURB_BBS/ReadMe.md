       ...
       Please Remit To:    TurboSoft TurboBBS
...

       ...
       ____    TurboBBS's latest version on a 5.25" disk   $7.00   ________

       ____    TurboBBS's latest version on a 3.5" disk   $10.00   ________
               (same as above except on new size media)

                                                        Subtotal   ________

          (All orders outside Canada add $2 Shipping)   Shipping   ________

          (Add $1 for Currency Exchange)           Misc. Charges   ________
...

       All checks must be drawn on Canada Funds in Canadian Dollars.
...
TurboBBS is in actual fact the latest version of MiniBBS.  We decided to change
...
TurboBBS was designed, created, and tested on a Lanpar PC Xt compatible, with
...
ONLINE.BAT  - The file that is called when a user with level 2, or 3 calls the
              ...
              that  is similar.  Please note:  If you do not add gateway (the
...
------------------------------------------------------------------------------

What goes on, when a regular caller calls TurboBBS.
...
Here is what the main menu, for regular callers looks like:
       ...
       ÕÍµ TurboBBS v1.00 ÆÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍµ Press '?' for Help! ÆÍ¸
       ³                                                                ³
       ³                       ³                      ³                 ³
       ...
       ³                       ³                      ³                 ³
       ³ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ³ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ³ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ³
       ³                       ³                      ³                 ³
...
------------------------------------------------------------------------------

What goes on, when a new user logs on.
...
here is what the menu looks like;
         ...
         ÕÍµ Local commands ÆÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¸
         ³                                                   ³
...
A reminder, Jonathan Rapoport, Matthew Stein, The author of Telix, and
...
If you have any problems, please read your Telix manual, or leave Matthew Stein,
