USRobotics Courier HST Telix Service Script Production Release 1.0
-------------------------------------------------------------------

(C) Copyright Andrzej Taramina 1988, 1989
...
This script will operate with TELIX 3.11 (and later
releases of TELIX).  Due to Telix Salt Script Language
dependencies, Release 1.0 of this script WILL NOT OPERATE under
pre-3.10 releases of Telix. It should run under 3.10 but has not
been tested under that release.
...
with Telix 3.11 or PCBoard 14.x, two menu options (TX and PC)
...
level at the time of this release), TLX_HST will allow you
...
Telix configuration file. Another text file, (TLX_HSTS.DOC)
included in this ARChive, will help you select the proper Telix
...
changes or improvements should be reported to the Canada Remote
Systems or Rose Media BBS's in Toronto.
...
settings.  A text file (TLX_HSTI.DOC) describing the HST's basic
internal operation is included in this ARChive; you may wish to review it
...
the TLX_HST.1ST file included in this ARChive.
...
Telix HST Service Script Release 1.0

HST MODEM SETUP UNDER Telix 3.11
...
will insure proper script operation under Telix release 3.11.
...
USR HST modem at the other end, to 19200 baud for the best speed.
